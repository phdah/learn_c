...
int main(int argc, char** argv)
{
  ...
  while ( fgets(str, 50, ptr) != NULL ) {
    ...
    if ( ( atoi(firstMin) >= atoi(secondMin) && atoi(firstMin) <= atoi(secondMax) ) ||
         ( atoi(secondMin) >= atoi(firstMin) && atoi(secondMin) <= atoi(firstMax) ) ||
         ( atoi(firstMax) >= atoi(secondMin) && atoi(firstMax) <= atoi(secondMax) ) ||
         ( atoi(secondMax) >= atoi(firstMin) && atoi(secondMax) <= atoi(firstMax) )
       ) {
      ++count;
    }
